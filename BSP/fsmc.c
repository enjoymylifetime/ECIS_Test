...
{  
	...
	//mytest
		...
		//*( vu16*)((u32)(Bank1_SRAM3_ADDR)+0) = 0x1ff1;
		kkkkk=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+0);
		
		//*( vu16*)((u32)(Bank1_SRAM3_ADDR)+4) = 0x5ff5;
		kkkkk=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+2);

		//*( vu16*)((u32)(Bank1_SRAM3_ADDR)+4) = 0x5ff5;
		//*( vu16*)((u32)(Bank1_SRAM3_ADDR)+4) = 0x5ff5;
		kkkkk=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+4);
		//*( vu16*)((u32)(Bank1_SRAM3_ADDR)+4) = 0x5ff5;
		//*( vu16*)((u32)(Bank1_SRAM3_ADDR)+4) = 0x5ff5;
		kkkkk=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+0X06);
		//*( vu16*)((u32)(Bank1_SRAM3_ADDR)+4) = 0x5ff5;
		kkkkk=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+0X08);
		kkkkk=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+0X0a);
		kkkkk=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+0X0c);
		kkkkk=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+0X0e);
		kkkkk=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+0X10);

		  L_Part=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+0);
		  H_Part=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+2);	
                L_Part=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+4);
		  H_Part=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+6);
		  L_Part=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+8);
		  H_Part=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+10);
		  L_Part=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+12);
		  H_Part=*( vu16*)((u32)(Bank1_SRAM3_ADDR)+14);
...
void FSMC_SRAM_Init(void)
{
	...
	*/
	...
	GPIO_InitStructure.GPIO_Pin = (3<<0)|(3<<4)|(0XDF<<8);//PD0,1,4,5,8~15 AF OUT   原为FF  先A18改为输入IO
	...
	//GPIO_PinAFConfig(GPIOD,GPIO_PinSource12,GPIO_AF_FSMC);    A17   暂时不用  作为软复位信号
	//GPIO_PinAFConfig(GPIOD,GPIO_PinSource13,GPIO_AF_FSMC);    A18   暂时不用  作为脉冲中断信号
