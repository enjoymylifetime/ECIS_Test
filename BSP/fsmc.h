...
#define Bank1_SRAM1_ADDR    ((u32)(0x60000000))	  //NE1选通
#define Bank1_SRAM2_ADDR    ((u32)(0x64000000))	  //NE2选通
#define Bank1_SRAM3_ADDR    ((u32)(0x68000000))	  //NE3选通
#define Bank1_SRAM4_ADDR    ((u32)(0x6c000000))	  //NE4选通
